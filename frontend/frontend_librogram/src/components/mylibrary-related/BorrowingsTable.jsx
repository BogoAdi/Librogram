...
function EnhancedTableToolbar(props) {
    const { numSelected, handleDelete, handleApprove, handleReject } = props;
        ...
        >
            ...
            {numSelected > 0 && (
                <>
                    ...
                    <Tooltip title="Approve borrow request">
                        <IconButton onClick={() => handleApprove()}>
                            <ApprovalIcon />
                        </IconButton>
                    </Tooltip>
                    <Tooltip title="Reject borrow request">
...
const BorrowingsTable = ({ rows, onUpdateRows, key, onUpdatedState }) => {
    ...
    const handleApprove = () => {
        if (selected.length > 0) {
            SetStateBorrowing(selected, 1);
        }
    }
    const handleReject = () => {
        if (selected.length > 0) {
            SetStateBorrowing(selected, 3)
        }
    }
    return (
        <Box sx={{ width: '100%' }}>
